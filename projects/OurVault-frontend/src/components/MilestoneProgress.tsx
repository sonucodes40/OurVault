  ...
  return (
    <div className="w-full max-w-3xl p-6 rounded-2xl border border-slate-800 bg-linear-to-br from-[#0f172a] to-[#020617] shadow-xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="text-xs px-3 py-1.5 rounded-lg border border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 transition">
          View Details
        </button>
      </div>
          ...
          <div className="relative">
            ...
            <div
              className="
                ...
                hover:[&::-webkit-scrollbar-thumb]:bg-cyan-400/70
